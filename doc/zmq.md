...
The CCCC Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in CCCC Core requires ZeroMQ API version 4.x or
...
using. CCCCd appends an up-counting sequence number to each
