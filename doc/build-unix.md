UNIX BUILD NOTES
====================
Some notes on how to build CCCC in Unix.
...
memory available when compiling CCCC Core. With 512MB of memory or less
...
If you want to build CCCC-Qt, make sure that the required packages for Qt development
...
# Configure CCCC Core to use our own-built instance of BDB
cd $CCCC_ROOT
...
Security
--------
To help make your CCCC installation more secure by making certain attacks impossible to
