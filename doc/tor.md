...
It is possible to run CCCC as a Tor hidden service, and connect to such services.
...
Run CCCC behind a Tor proxy
----------------------------------

The first step is running CCCC behind a Tor proxy. This will already make all
