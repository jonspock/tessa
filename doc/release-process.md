...
* Update translations see [translation_process.md](https://github.com/CCCC-Project/CCCC/blob/master/doc/translation_process.md#synchronising-translations).
...
### CCCC maintainers/release engineers, suggestion for writing release notes
...
### Build and sign CCCC Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [pivx-detached-sigs](https://github.com/CCCC-Project/pivx-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/CCCC-Project/CCCC/releases/new) with a link to the archived release notes.
