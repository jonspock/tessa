...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/CCCC-Project/CCCC.git
        cd CCCC
...
Once dependencies are compiled, see release-process.md for how the CCCC-Qt.app
...
commands:
    ...
    echo -e "rpcuser=pivxrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/CCCC/pivx.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/CCCC/pivx.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/CCCC/debug.log
