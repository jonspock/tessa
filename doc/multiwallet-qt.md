...
In order to support loading of multiple wallets in tessa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tessa.cpp.
...
Changes to tessa.cpp
----------------------
tessa.cpp is the entry point into tessa-qt, and as such, will require some minor modifications to provide hooks for
