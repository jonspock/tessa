...
bool static IsLowDERSignature(const valtype& vchSig, ScriptError* serror) {
  ...
  if (!eccrypto::CheckSignatureElement(S, nLenS, true)) return set_error(serror, SCRIPT_ERR_SIG_HIGH_S);
...
class CTransactionSignatureSerializer {
 ...
 public:
  ...
  template <typename S> void SerializeScriptCode(S& s, int nType, int nVersion) const {
  ...
  template <typename S> void SerializeInput(S& s, unsigned int nInput, int nType, int nVersion) const {
  ...
  template <typename S> void SerializeOutput(S& s, unsigned int nOutput, int nType, int nVersion) const {
  ...
  /** Serialize txTo */
  template <typename S> void Serialize(S& s, int nType, int nVersion) const {
    // Serialize nVersion
