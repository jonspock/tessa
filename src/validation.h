...
static const uint32_t DEFAULT_MIN_RELAY_TX_FEE = 1000;
...
static const uint32_t DEFAULT_DESCENDANT_LIMIT = 25;
/** Default for -limitdescendantsize, maximum kilobytes of in-mempool
 * descendants */
static const uint32_t DEFAULT_DESCENDANT_SIZE_LIMIT = 101;
/** Default for -mempoolexpiry, expiration time for mempool transactions in
 * hours */
static const uint32_t DEFAULT_MEMPOOL_EXPIRY = 336;
...
static const uint32_t DATABASE_WRITE_INTERVAL = 60 * 60;
/** Time to wait (in seconds) between flushing chainstate to disk. */
static const uint32_t DATABASE_FLUSH_INTERVAL = 24 * 60 * 60;
/** Maximum length of reject messages. */
static const uint32_t MAX_REJECT_MESSAGE_LENGTH = 111;
/** Average delay between local address broadcasts in seconds. */
static const uint32_t AVG_LOCAL_ADDRESS_BROADCAST_INTERVAL = 24 * 24 * 60;
/** Average delay between peer address broadcasts in seconds. */
static const uint32_t AVG_ADDRESS_BROADCAST_INTERVAL = 30;
/** Average delay between trickled inventory transmissions in seconds.
 *  Blocks and whitelisted receivers bypass this, outbound peers get half this
 * delay. */
static const uint32_t INVENTORY_BROADCAST_INTERVAL = 5;
/** Maximum number of inventory items to send per transmission.
 *  Limits the impact of low-fee transaction floods. */
static const uint32_t INVENTORY_BROADCAST_MAX =
    7 * INVENTORY_BROADCAST_INTERVAL;
/** Average delay between feefilter broadcasts in seconds. */
static const uint32_t AVG_FEEFILTER_BROADCAST_INTERVAL = 10 * 60;
/** Maximum feefilter broadcast delay after significant change. */
static const uint32_t MAX_FEEFILTER_CHANGE_DELAY = 5 * 60;
...
static const uint32_t DEFAULT_BANSCORE_THRESHOLD = 100;
 ...
 * message.*/
static const uint32_t MAX_BLOCKS_TO_ANNOUNCE = 8;
...
static const uint32_t MIN_BLOCKS_TO_KEEP = 288;
...
public:
    ...
    CScriptCheck(const CScript &scriptPubKeyIn, const CAmount amountIn,
                 const CTransaction &txToIn, uint32_t nInIn,
 ...
 */
static const uint32_t REJECT_INTERNAL = 0x100;
/** Too high fee. Can not be triggered by P2P transactions */
static const uint32_t REJECT_HIGHFEE = 0x100;
/** Transaction is already known (either in mempool or blockchain) */
static const uint32_t REJECT_ALREADY_KNOWN = 0x101;
/** Transaction conflicts with a transaction already known */
static const uint32_t REJECT_CONFLICT = 0x102;
