...
TEST_CASE("key_test1") {
  ...
  REQUIRE(detsig == ParseHex("30450221009071d4fead181ea197d6a23106c48ee5de25e023b38afaf71c170e3088e5238a02200dcbc7f1aad"
                             "626a5ee812e08ef047114642538e423a94b4bd6a272731cf500d0"));
  REQUIRE(key2.Sign(hashMsg, detsig));
  REQUIRE(key2C.Sign(hashMsg, detsigc));
  REQUIRE(detsig == detsigc);
  REQUIRE(detsig == ParseHex("304402204f304f1b05599f88bc517819f6d43c69503baea5f253c55ea2d791394f7ce0de02204f23c0d4c1f4d"
                             "7a89bf130fed755201d22581911a8a44cf594014794231d325a"));
  REQUIRE(key1.SignCompact(hashMsg, detsig));
  REQUIRE(key1C.SignCompact(hashMsg, detsigc));
  REQUIRE(detsig == ParseHex("1b9071d4fead181ea197d6a23106c48ee5de25e023b38afaf71c170e3088e5238a0dcbc7f1aad626a5ee812e0"
                             "8ef047114642538e423a94b4bd6a272731cf500d0"));
  REQUIRE(detsigc == ParseHex("1f9071d4fead181ea197d6a23106c48ee5de25e023b38afaf71c170e3088e5238a0dcbc7f1aad626a5ee812e"
                              "08ef047114642538e423a94b4bd6a272731cf500d0"));
  REQUIRE(key2.SignCompact(hashMsg, detsig));
  REQUIRE(key2C.SignCompact(hashMsg, detsigc));
  REQUIRE(detsig == ParseHex("1b4f304f1b05599f88bc517819f6d43c69503baea5f253c55ea2d791394f7ce0de4f23c0d4c1f4d7a89bf130f"
                             "ed755201d22581911a8a44cf594014794231d325a"));
  REQUIRE(detsigc == ParseHex("1f4f304f1b05599f88bc517819f6d43c69503baea5f253c55ea2d791394f7ce0de4f23c0d4c1f4d7a89bf130"
                              "fed755201d22581911a8a44cf594014794231d325a"));
}
