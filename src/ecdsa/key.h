...
class CKey {
 ...
 public:
  ...
  //! Initialize from a CSecretKey
  bool SetPrivKey(const CSecretKey& vchPrivKey, bool fCompressed);
  ...
  /**
   * Convert the private key to a CSecretKey 
   * This is expensive.
   */
  ...
  bool Load(const CSecretKey& privkey, const CPubKey& vchPubKey, bool fSkipCheck);
