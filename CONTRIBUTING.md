Contributing to CCCC Core
============================

The CCCC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CCCC Core project, and is not to be
confused with overall CCCC Network Protocol consensus changes.

Whether a pull request is merged into CCCC Core rests with the project merge
...
Patches that change CCCC consensus rules are considerably more involved than
...
Where a patch set proposes to change the CCCC consensus, it must have been
...
The project leader is the release manager for each CCCC Core release.
